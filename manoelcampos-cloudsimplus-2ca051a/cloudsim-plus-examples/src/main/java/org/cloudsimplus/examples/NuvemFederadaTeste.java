...
public class NuvemFederadaTeste {

    private static final int  HOST = 3;
    private static final int  HOST_MIPS = 1000;
    private static final long HOST_BW = 10_000; //in Megabits/s
    private static final int  HOST_PES = 16; //Total de cores por host
    ...
    public static void main(String[] args) {
        new NuvemFederadaTeste();
    }

    private NuvemFederadaTeste() {
...
/**
    ...
    private NetworkDatacenter createDatacenter() {
        ...
        return new NetworkDatacenter(simulation, hostList);
    }
...
/*
    ...
    */
/**
     * Creates a list of VMs => Módulos de Computação.
     *//*
    ...
    */
/**
     * Creates a list of Cloudlets => Jobs.
     *//*
